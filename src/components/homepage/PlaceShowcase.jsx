  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 md:order-2 px-4 md:px-12">
              <h2 className="text-4xl mb-10 md:text-5xl lg:text-8xl font-serif text-gray-900 leading-tight md:mb-80">
                Sensō-ji Temple
              </h2>
      ...
      <section className="py-16 md:py-24 md:pt-40 bg-neutral-50">
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden h-[70vh] md:h-[80vh]">
